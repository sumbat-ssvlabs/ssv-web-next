    ...
    >
      <Card className="flex-[1.7]">
        ...
        <Text className="text-gray-600">
          ...
          waiting. During this period, your validator must remain active, so it
          is crucial to maintain your validator's performance and keep it
          registered with the SSV network until it has fully exited.
        </Text>
        <Alert variant="warning">
          <AlertDescription>
            Exiting your validator from the Beacon Chain is permanent and cannot
            be reversed, preventing any future reactivation.
          </AlertDescription>
        </Alert>
        ...
        <label htmlFor="agree-2" className="flex gap-3 pt-6">
          ...
          <Text>
            ...
            duties while in the exit queue, and it's up to me to remove it from
            the SSV network once completed to stop incurring fees.
          </Text>
        </label>
