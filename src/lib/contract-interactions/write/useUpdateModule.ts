...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "updateModule">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "updateModule");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useUpdateModule = (options?: MutationOptions<MainnetEvent>) => {
