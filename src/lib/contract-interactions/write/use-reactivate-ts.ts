...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "reactivate">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "reactivate");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useReactivate = (options?: MutationOptions<MainnetEvent>) => {
