...
type WriteMutationOptions = Pick<
  ...
  "mutation"
>;
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "updateNetworkFee">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "updateNetworkFee");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useUpdateNetworkFee = (
