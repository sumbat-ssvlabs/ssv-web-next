...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "exitValidator">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "exitValidator");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useExitValidator = (options?: MutationOptions<MainnetEvent>) => {
