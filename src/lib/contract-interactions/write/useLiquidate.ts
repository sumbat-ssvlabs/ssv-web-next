...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "liquidate">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "liquidate");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useLiquidate = (options?: MutationOptions<MainnetEvent>) => {
