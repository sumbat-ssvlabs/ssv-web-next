...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "withdraw">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "withdraw");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useWithdraw = (options?: MutationOptions<MainnetEvent>) => {
