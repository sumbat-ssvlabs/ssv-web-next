...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "initialize">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "initialize");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useInitialize = (options?: MutationOptions<MainnetEvent>) => {
