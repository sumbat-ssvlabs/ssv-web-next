...
export const getGetValidatorsPerOperatorLimitQueryOptions = () =>
...
export const fetchGetValidatorsPerOperatorLimit = () =>
  queryClient.fetchQuery(getGetValidatorsPerOperatorLimitQueryOptions());

export const useGetValidatorsPerOperatorLimit = (options?: QueryOptions) => {
