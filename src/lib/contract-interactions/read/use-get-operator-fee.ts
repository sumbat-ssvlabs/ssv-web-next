...
export const getGetOperatorFeeQueryOptions = (
...
export const fetchGetOperatorFee = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getGetOperatorFeeQueryOptions(params));

export const useGetOperatorFee = (
  params: AbiInputsToParams<Fn["inputs"]>,
