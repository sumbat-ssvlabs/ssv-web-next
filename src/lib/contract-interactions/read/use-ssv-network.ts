...
export const getSsvNetworkQueryOptions = () =>
...
export const fetchSsvNetwork = () =>
  queryClient.fetchQuery(getSsvNetworkQueryOptions());

export const useSsvNetwork = (options?: QueryOptions) => {
